...
{	
    PLIB_IC_ModeSelect(IC_ID_5, IC_INPUT_CAPTURE_RISING_EDGE_MODE);
    PLIB_IC_FirstCaptureEdgeSelect(IC_ID_5, IC_EDGE_RISING);
    PLIB_IC_TimerSelect(IC_ID_5, IC_TIMER_TMR2);
    PLIB_IC_BufferSizeSelect(IC_ID_5, IC_BUFFER_SIZE_32BIT);
    PLIB_IC_EventsPerInterruptSelect(IC_ID_5, IC_INTERRUPT_ON_EVERY_CAPTURE_EVENT);   

    /* Setup Interrupt */   
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_INPUT_CAPTURE_5);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_IC5, INT_PRIORITY_LEVEL7);
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_IC5, INT_SUBPRIORITY_LEVEL0);          
}
