...
set(2414_DES_SP7_TestSprinkler_default_default_XC32_FILE_TYPE_compile
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/src/Driver_SR_SN74HCS596QPWRQ1.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/src/Mc32DriverAdc.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/src/Mc32_I2cUtilCCS.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/src/Mc32_sdFatGest.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/src/Mc32gestI2cSeeprom.c"
    ...
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/src/mcp79411.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/src/system_config/default/framework/driver/adc/src/drv_adc_static.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/src/system_config/default/framework/driver/spi/dynamic/drv_spi_api.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/src/system_config/default/framework/driver/spi/dynamic/drv_spi_master_ebm_tasks.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../firmware/src/system_config/default/framework/driver/spi/dynamic/drv_spi_tasks.c"
...
set(2414_DES_SP7_TestSprinkler_default_internal_image_name "${CMAKE_CURRENT_SOURCE_DIR}/../../../_build/2414-DES_SP7_TestSprinkler/default/default.elf")

# The name of the resulting image, including namespace for configuration.
set(2414_DES_SP7_TestSprinkler_default_image_name "2414_DES_SP7_TestSprinkler_default_default.elf")

# The name of the image, excluding the namespace for configuration.
set(2414_DES_SP7_TestSprinkler_default_original_image_name "default.elf")
