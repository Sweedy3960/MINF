...
function(A_2414_DES_SP7_TestSprinkler_default_default_XC32_assemble_rule target)
    set(options
        ...
        "-Wa,--defsym=__MPLAB_BUILD=1${MP_EXTRA_AS_POST},--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--gdwarf-2,-I${CMAKE_CURRENT_SOURCE_DIR}/../../../2414-DES_SP7_TestSprinkler.X"
        "-mdfp=${PACK_REPO_PATH}/Microchip/PIC32MX_DFP/1.5.259")
    list(REMOVE_ITEM options "")
    target_compile_options(${target} PRIVATE "${options}")
    target_compile_definitions(${target} PRIVATE "__DEBUG")
    target_include_directories(${target} PRIVATE "${CMAKE_CURRENT_SOURCE_DIR}/../../../2414-DES_SP7_TestSprinkler.X")
endfunction()
function(A_2414_DES_SP7_TestSprinkler_default_default_XC32_assembleWithPreprocess_rule target)
    set(options
        ...
        "-mprocessor=32MX795F512L"
        "-Wa,--defsym=__MPLAB_BUILD=1${MP_EXTRA_AS_POST},--defsym=__MPLAB_DEBUG=1,--gdwarf-2,--defsym=__DEBUG=1,-I${CMAKE_CURRENT_SOURCE_DIR}/../../../2414-DES_SP7_TestSprinkler.X")
    list(REMOVE_ITEM options "")
    target_compile_options(${target} PRIVATE "${options}")
...
function(A_2414_DES_SP7_TestSprinkler_default_default_XC32_compile_rule target)
    ...
    target_include_directories(${target}
        ...
        PRIVATE "${CMAKE_CURRENT_SOURCE_DIR}/../../../2414-DES_SP7_TestSprinkler.X")
endfunction()
...
function(A_2414_DES_SP7_TestSprinkler_default_link_rule target)
    set(options
        ...
        "${DEBUGGER_NAME_AS_MACRO}"
        "-mprocessor=32MX795F512L"
        "-Wl,--defsym=__MPLAB_BUILD=1${MP_EXTRA_LD_POST},--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=_min_heap_size=0,--gc-sections,--no-code-in-dinit,--no-dinit-in-serial-mem,-L${CMAKE_CURRENT_SOURCE_DIR}/../../../2414-DES_SP7_TestSprinkler.X,--memorysummary,memoryfile.xml"
        "-mdfp=${PACK_REPO_PATH}/Microchip/PIC32MX_DFP/1.5.259")
    list(REMOVE_ITEM options "")
