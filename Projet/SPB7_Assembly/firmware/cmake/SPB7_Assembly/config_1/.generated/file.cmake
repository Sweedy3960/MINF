...
set(SPB7_Assembly_config_1_config_1_toolchain_FILE_TYPE_assemble)
set_source_files_properties(${SPB7_Assembly_config_1_config_1_toolchain_FILE_TYPE_assemble} PROPERTIES LANGUAGE ASM)
set(SPB7_Assembly_config_1_config_1_toolchain_FILE_TYPE_assembleWithPreprocess)
set_source_files_properties(${SPB7_Assembly_config_1_config_1_toolchain_FILE_TYPE_assembleWithPreprocess} PROPERTIES LANGUAGE ASM)
set(SPB7_Assembly_config_1_config_1_toolchain_FILE_TYPE_compile
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../../../../../../framework/system/int/src/sys_int_pic32.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../../../SPB7_TouchCapa/firmware/src/Display.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../../../SPB7_TouchCapa/firmware/src/LCD_Driver.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../../../SPB7_TouchCapa/firmware/src/appDisp.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../../../SPB7_TouchCapa/firmware/src/app_eventbus.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../../../SPB7_TouchCapa/firmware/src/app_taskctrl.c"
    "${CMAKE_CURRENT_SOURCE_DIR}/../../../../../SPB7_TouchCapa/firmware/src/ugui.c"
...
set_source_files_properties(${SPB7_Assembly_config_1_config_1_toolchain_FILE_TYPE_compile} PROPERTIES LANGUAGE C)
set(SPB7_Assembly_config_1_config_1_toolchain_FILE_TYPE_compile_cpp)
set_source_files_properties(${SPB7_Assembly_config_1_config_1_toolchain_FILE_TYPE_compile_cpp} PROPERTIES LANGUAGE CXX)
set(SPB7_Assembly_config_1_config_1_toolchain_FILE_TYPE_link "${CMAKE_CURRENT_SOURCE_DIR}/../../../../../../../../bin/framework/peripheral/PIC32MX795F512L_peripherals.a")
set(SPB7_Assembly_config_1_image_name "config_1.elf")


# The output directory of the final image.
set(SPB7_Assembly_config_1_output_dir "${CMAKE_CURRENT_SOURCE_DIR}/../../../out/SPB7_Assembly")
