...
#ifndef _APP_INPUTS_H
#define _APP_INPUTS_H
...
typedef enum
{
	...
	APP_INPUTS_STATE_INIT=0,
	APP_INPUTS_STATE_SERVICE_TASKS,
    APP_INPUTS_STATE_IDLE,
...
/**
 * @brief Lit tous les échantillons ADC.
 *
 * @return void
 */
void APP_AdcReadAllSamples(void);
/**
 * @brief Récupère l'état des entrées.
 *
 * @return void
 */
void APP_GetInputsStates(void);
/**
 * @brief Callback du timer ADC.
 *
 * @return void
 */
